...
def create_patrol_zone(side, pos):
    ...
    # lat: 纬度， lon：经度
    rp1 = side.add_reference_point('红方', 'strike_rp1', lat + 0.3, lon - 0.3)
    rp2 = side.add_reference_point('红方', 'strike_rp2', lat + 0.3, lon + 0.3)
    rp3 = side.add_reference_point('红方', 'strike_rp3', lat - 0.3, lon + 0.3)
    rp4 = side.add_reference_point('红方', 'strike_rp4', lat - 0.3, lon - 0.3)
