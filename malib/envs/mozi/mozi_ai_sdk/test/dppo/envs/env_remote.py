...
import time
from malib.envs.mozi.mozi_simu_sdk.mozi_server_remote import MoziServer
from malib.envs.mozi.mozi_ai_sdk.test.bt_test2.bt_agent_antiship import CAgent
from malib.envs.mozi.mozi_ai_sdk.test.dppo.envs.common.utils import *
from malib.envs.mozi.mozi_ai_sdk.test.dppo.envs import etc
...
class Environment:
    ...
    def __init__(self, IP, AIPort, duration_interval):
        #
        self.server_ip = IP
        self.aiPort = AIPort
    ...
    def create_battle_zone(side, side_name):
        ...
        side.add_reference_point(side_name, zone[0], patrolBoundingBox[0]['latitude'], patrolBoundingBox[0]['longitude'])
        side.add_reference_point(side_name, zone[1], patrolBoundingBox[1]['latitude'], patrolBoundingBox[1]['longitude'])
        side.add_reference_point(side_name, zone[2], patrolBoundingBox[2]['latitude'], patrolBoundingBox[2]['longitude'])
        side.add_reference_point(side_name, zone[3], patrolBoundingBox[3]['latitude'], patrolBoundingBox[3]['longitude'])
    ...
    def create_offensive_patrol_zone(side, side_name):
        ...
        side.add_reference_point(side_name, zone[0], hostileContactBoundingBox[0]['latitude'], hostileContactBoundingBox[0]['longitude'])
        side.add_reference_point(side_name, zone[1], hostileContactBoundingBox[1]['latitude'], hostileContactBoundingBox[1]['longitude'])
        side.add_reference_point(side_name, zone[2], hostileContactBoundingBox[2]['latitude'], hostileContactBoundingBox[2]['longitude'])
        side.add_reference_point(side_name, zone[3], hostileContactBoundingBox[3]['latitude'], hostileContactBoundingBox[3]['longitude'])
    ...
    def create_defensive_patrol_zone(side, side_name):
        ...
        side.add_reference_point(side_name, 'rp2', rp12mid['latitude'], rp12mid['longitude'])
        side.add_reference_point(side_name, 'rp3', rp13mid['latitude'], rp13mid['longitude'])
        side.add_reference_point(side_name, 'rp4', rp14mid['latitude'], rp14mid['longitude'])
        side.add_reference_point(side_name, 'rp5', rp23mid['latitude'], rp23mid['longitude'])
        side.add_reference_point(side_name, 'rp6', rp34mid['latitude'], rp34mid['longitude'])
