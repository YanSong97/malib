...
APP_ABSPATCH = os.path.dirname(__file__)
USE_CUDA = False
...
#######################
TMP_PATH = "%s/%s/tmp" % (APP_ABSPATCH, SCENARIO_NAME)
OUTPUT_PATH = "%s/%s/output" % (APP_ABSPATCH, SCENARIO_NAME)
