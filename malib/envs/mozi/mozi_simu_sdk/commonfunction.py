...
#import mozi_simu_sdk.database as db
import malib.envs.mozi.mozi_simu_sdk.database as db
#from MoZiAI_SDK.core.entitys import geo
from malib.envs.mozi.mozi_simu_sdk import geo
...
DISTANCE_RANGE = math.sqrt(
    LAT_GRID_UNIT_LENGTH * LAT_GRID_UNIT_LENGTH + LON_GRID_UNIT_LENGTH * LON_GRID_UNIT_LENGTH)  # 每单元格对角线距离
...
def get_grid_from_distance2(location, distance_km, subarray_ret=False):
    ...
    if cal_dis <= 0:
        ...
        if subarray_ret:
            ...
            all_area[new_lat_index: new_lat_index + new_in_area.shape[0],
            new_lon_index: new_lon_index + new_in_area.shape[1]] = new_in_area
            return all_area
