...
python3 -m gfootball.play_game --players "keyboard:left_players=1;football_ai:right_players=1, \
    checkpoint=$PATH" --action_set=full

$PATH is the path where model are loaded;
--players means there is one left player controlled by keyboard and other 3 controlled by bulit-in AI, one right player \
    controlled by our own model, other 3 controlled by built-in AI;
"""
